...
val lookup_class_name : ?finalise:(char Ctypes.CArray.t -> unit) -> Pci_access.t -> int -> string option
...
val lookup_progif_name : ?finalise:(char Ctypes.CArray.t -> unit) -> Pci_access.t -> int -> int -> string option
...
val lookup_vendor_name : ?finalise:(char Ctypes.CArray.t -> unit) -> Pci_access.t -> int -> string option
(** [lookup_vendor_name a id] is like {!lookup_class_name} but returns
    the name of the PCI vendor with ID [id]. *)

val lookup_device_name : ?finalise:(char Ctypes.CArray.t -> unit) -> Pci_access.t -> int -> int -> string option
...
val lookup_subsystem_vendor_name : ?finalise:(char Ctypes.CArray.t -> unit) -> Pci_access.t -> int -> string option
(** [lookup_subsystem_vendor_name a id] is like {!lookup_class_name} but
    returns the name of the PCI vendor with ID [id]. *)

val lookup_subsystem_device_name : ?finalise:(char Ctypes.CArray.t -> unit) -> Pci_access.t -> int -> int -> int -> int -> string option
